  ...
  return (
    <View style={styles.main}>
      ...
      <View style={styles.heading}>
        <Text style={[styles.center, styles.h1]}>Welcome to</Text>
        <Text style={[styles.center, styles.h1]}>iLendu</Text>

        <Text style={[styles.center, styles.subheading]}>
          Lend and borrow items between members of your community
        </Text>
      </View>
